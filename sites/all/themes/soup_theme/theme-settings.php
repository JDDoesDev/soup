 ...
 *   The form state.
 */
function soup_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['tabs'] = array(
    '#type' => 'vertical_tabs',
    '#attached' => array(
      'css' => array(drupal_get_path('theme', 'soup_theme') . '/soup_theme.settings.form.css'),
    ),
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_select_menu']['responsive_menu_switchwidth'] = array(
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_js'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_js','soup_theme'),
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_latitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_latitude','soup_theme'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_longitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_longitude','soup_theme'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_zoom'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_zoom','soup_theme'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_canvas'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_canvas','soup_theme'),
  );
