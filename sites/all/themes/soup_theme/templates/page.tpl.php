...
<div id="page-container">
            ...
            <div id="header-inside" class="clearfix">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php if ($logo):?>
                        <div id="logo">
                        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"> <img src="<?php print $logo; ?>" alt="<?php print t('South Shore Soup logo'); ?>" /> </a>
                        </div>
                        <?php endif; ?>
    ...
    <?php include drupal_get_path('theme', 'soup_theme') . '/includes/internal-banner.inc'; ?>
