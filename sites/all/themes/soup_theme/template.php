 ...
 */
function soup_theme_breadcrumb($variables){
 ...
 */
function soup_theme_preprocess_block(&$variables) {
 ...
 */
function soup_theme_preprocess_html(&$variables) {
	...
	if ($color_scheme != 'default') {
		drupal_add_css(path_to_theme() . '/css/style-' .$color_scheme. '.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	 ...
	 */
	drupal_add_css(path_to_theme() . '/css/local.css', array('group' => CSS_THEME, 'type' => 'file'));
	...
	*/
	...
	if (theme_get_setting('responsive_menu_state')) {
        ...
        drupal_add_js(array('soup_theme' => array('topoptiontext' => $responsive_menu_topoptiontext)), 'setting');
		$responsive_menu_nested = theme_get_setting('responsive_menu_nested');
		...
		$("#main-navigation ul.main-menu, #main-navigation .content>ul.menu").mobileMenu({
            ...
            topOptionText: Drupal.settings.soup_theme[\'topoptiontext\']
		});
	...
	if (theme_get_setting('google_map_js')) {
        ...
        drupal_add_js(array('soup_theme' => array('google_map_latitude' => $google_map_latitude)), 'setting');
		$google_map_longitude = theme_get_setting('google_map_longitude');
        drupal_add_js(array('soup_theme' => array('google_map_longitude' => $google_map_longitude)), 'setting');
		$google_map_zoom = (int) theme_get_setting('google_map_zoom');
		$google_map_canvas = theme_get_setting('google_map_canvas');
        drupal_add_js(array('soup_theme' => array('google_map_canvas' => $google_map_canvas)), 'setting');
 ...
 * Override or insert variables into the html template.
 */
function soup_theme_process_html(&$vars) {
 ...
 */
function soup_theme_preprocess_page(&$variables) {
...
*/
function soup_theme_preprocess_maintenance_page(&$variables) {
...
function soup_theme_page_alter($page) {
...
function soup_theme_form_alter(&$form, &$form_state, $form_id) {
